...
$sesfulln = $_SESSION['fulln'];
 ...
 if (empty($sesmail)){header("Location:logoutadmin.php");}
   ...
   <body class="hold-transition sidebar-mini">
      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Welcome Administrator <?php echo $sesfulln; ?></h1>
         ...
         <footer class="main-footer">
            <strong>Copyright &copy; 2019<a href="#">BOSAcademy</a>.</strong> All rights reserved.
         </footer>
      </div>
      <!-- /.wrapper -->
      <!-- Start Core Plugins
